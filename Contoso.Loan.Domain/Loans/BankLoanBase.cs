...
using Visma.Loan.Domain.Exceptions;
...
namespace Visma.Loan.Domain.Loans
{
    ...
    public abstract class BankLoanBase
    {
        ...
        protected BankLoanBase(decimal principal, int term, decimal interestRatePercentage, CurrencyType currency, LoanType loanType)
        {
            Id = Guid.NewGuid(); 
            Currency = currency;
            Principal = principal;
