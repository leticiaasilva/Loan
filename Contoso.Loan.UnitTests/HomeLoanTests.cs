...
namespace Visma.Loan.MvcServices.Tests
{
    ...
    public class HomeLoanTests
    {
        ...
        {
            // Arrange
            var loan = new HomeLoan(1000, 3, -2.5m, CurrencyType.Euro, LoanType.HomeLoan);
        ...
        {
            // Arrange
            var loan = new HomeLoan(0, 3, 2.5m, CurrencyType.Euro, LoanType.HomeLoan);
        ...
        {
            // Arrange
            var loan = new HomeLoan(1000, 0, 2.5m, CurrencyType.Euro, LoanType.HomeLoan);
        ...
        {
            // Arrange
            var loan = new HomeLoan(1000, 1, 2.5m, CurrencyType.Euro, LoanType.HomeLoan);
        ...
        public void HomeLoanConstructor_WhenInitializedByConstructor_PropertiesAreSetCorrectly()
        {
            ...
            LoanType loanType = LoanType.HomeLoan;



            // Act
            var loan = new HomeLoan(loanAmount, loanTerm, loanInterestRate, loanCurrency, loanType);
